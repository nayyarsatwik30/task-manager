...
import { Grid, Card, Typography, Box, LinearProgress, Chip, Avatar, Container } from '@mui/material';
...
const analytics = [
  { label: 'Total Tasks', value: 42, icon: <AssignmentTurnedInIcon color="primary" />, color: 'primary.main' },
  { label: 'Tasks Completed', value: 28, icon: <CheckCircleIcon color="success" />, color: 'success.main', progress: 67 },
  { label: 'Pending Tasks', value: 14, icon: <PendingActionsIcon color="warning" />, color: 'warning.main' },
  { label: 'Tasks Due Today', value: 3, icon: <CalendarTodayIcon color="secondary" />, color: 'secondary.main' },
];
